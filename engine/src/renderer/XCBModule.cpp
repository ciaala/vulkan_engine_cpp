...
void vlk::XCBModule::handleXCBEvent(const xcb_generic_event_t *event) {
  ...
  switch (event_code) {
    case XCB_EXPOSE:
      // TODO: Resize window
      FLOG(INFO) << "Event XCB_EXPOSE" << std::endl;
      break;
    case XCB_CLIENT_MESSAGE: {
      FLOG(INFO) << "Event XCB_CLIENT_MESSAGE" << std::endl;
    ...
    case XCB_KEY_RELEASE: {
      ...
      FLOG(INFO) << "Received KEY_RELEASE" << sym << std::endl;
    ...
    case XCB_CONFIGURE_NOTIFY: {
      FLOG(INFO) << "Event XCB_CONFIGURE_NOTIFY" << std::endl;
    ...
    case XCB_REPARENT_NOTIFY : {
      FLOG(INFO) << "Event XCB_REPARENT_NOTIFY" << std::endl;
      break;
    }
    case XCB_MAP_REQUEST : {
      FLOG(INFO) << "Event XCB_MAP_REQUEST" << std::endl;
      break;
    }

    case XCB_MAP_NOTIFY: {
      FLOG(INFO) << "Event XCB_MAP_NOTIFY" << std::endl;
      break;
    }
    default: {
      FLOG(INFO) << "Not handled event with code: " << event_code << std::endl;
      break;
    }
  }
}
